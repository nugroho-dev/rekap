  ...
  <div class="container-xl">
    <div class="row g-2 align-items-center">
      <div class="col">
        ...
        <h2 class="page-title">Tambah Data Konsultasi</h2>
      </div>
      <div class="col-auto ms-auto d-print-none">
        <a href="{{ url('/konsultasi') }}" class="btn btn-primary">
...
<div class="col-md-12 ">
  <form class="card" method="post" action="{{ route('konsultasi.store') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="card-body">
      <div class="row row-cards">
        <!-- id_rule dibuat otomatis di backend, tidak perlu input di form -->
        <div class="col-md-6">
          <div class="mb-3">
        ...
        <div class="col-md-6">
          <div class="mb-3">
            ...
            <select class="form-select" name="jenis">
              <option value="Konsultasi" {{ old('jenis') == 'Konsultasi' ? 'selected' : '' }}>Konsultasi</option>
