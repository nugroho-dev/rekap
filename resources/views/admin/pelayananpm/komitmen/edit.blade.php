                ...
                <div class="card">
                  ...
                  <div class="row justify-content-center m-3">
                    <div class="col-lg-9 col-md-12 col-sm-12">
                      <form class="card" method="post" action="{{ url('/commitment/'.$commitment->id_rule.'') }}" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <div class="card-body">
                          <h3 class="card-title"> {{ $judul }}</h3>
                          <div class="row row-cards">
                            <div class="col-md-12 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nama_pelaku_usaha" placeholder="Nama Pelaku Usaha"  id="title" value="{{ old('nama_pelaku_usaha', $commitment->nama_pelaku_usaha) }}">
                            ...
                            <div class="col-md-12 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Alamat Pelaku Usaha" name="alamat_pelaku_usaha"  value="{{ old('alamat_pelaku_usaha', $commitment->alamat_pelaku_usaha) }}">
                            ...
                            <div class="col-md-4 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nib" placeholder="Nomor Induk Berusaha" value="{{ old('nib', $commitment->nib) }}">
                                @error ('nib')
                                <small class="form-hint text-danger">{{ $message }}  </small>
                                @enderror
                              </div>
                            ...
                            <div class="col-md-8 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nama_proyek" placeholder="Nama Proyek" value="{{ old('nama_proyek', $commitment->nama_proyek) }}">
                                @error ('nama_proyek')
                                <small class="form-hint text-danger">{{ $message }}  </small>
                                @enderror
                              </div>
                            ...
                            <div class="col-md-9 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="jenis_izin" placeholder="Jenis Izin"   value="{{ old('jenis_izin', $commitment->jenis_izin) }}">
                                @error ('jenis_izin')
                                <small class="form-hint text-danger">{{ $message }}  </small>
                                @enderror
                              </div>
                            ...
                            <div class="col-md-3 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="status" placeholder="Status"   value="{{ old('status', $commitment->status) }}">
                                @error ('status')
                                <small class="form-hint text-danger">{{ $message }}  </small>
                                @enderror
                              </div>
                            ...
                            <div class="col-md-3 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="date" class="form-control" name="tanggal_izin_terbit"  value="{{ old('tanggal_izin_terbit', $commitment->tanggal_izin_terbit) }}">
                                @error ('tanggal_izin_terbit')
                                <small class="form-hint text-danger">{{ $message }}  </small>
                                @enderror
                              </div>
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="keterangan" placeholder="Keterangan"  value="{{ old('keterangan', $commitment->keterangan) }}">
                                @error ('keterangan')
                                <small class="form-hint text-danger">{{ $message }}  </small>
                                @enderror
                              </div>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="flexible-container">
                        <embed src="{{ url(Storage::url($commitment->file)) }}" class="docpdf-preview" id="my-object" width="100%" type="application/pdf" height="650"></embed>
                      </div>
                    </div>
                    <div class="modal-footer">
