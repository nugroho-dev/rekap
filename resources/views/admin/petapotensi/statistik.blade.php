    ...
    <div class="page-header d-print-none mb-3">
        <div class="row align-items-center">
            <div class="col">
                ...
                <div class="text-muted mt-1">Statistik peta potensi berdasarkan tahun dan tren bulanan.</div>
            </div>
        ...
        <div class="col-md-3">
            <div class="card shadow-sm border-0">
                <div class="card-body text-center">
                    ...
                    <div class="text-muted">Total Peta Potensi</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="card shadow-lg border-0">
                <div class="card-header bg-primary-lt">
                    <h3 class="card-title mb-0">Tren Peta Potensi Tahun {{ $year }}</h3>
                </div>
        ...
        <div class="col-md-6">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-yellow-lt">
                    <h3 class="card-title mb-0">Jumlah Peta Potensi per Tahun</h3>
                </div>
                <div class="card-body pb-0">
                    <table class="table table-bordered table-sm mb-3">
                        ...
                        <tbody>
                            @foreach($tahunCounts as $tahun => $jumlah)
                            <tr>
                                <td>{{ $tahun }}</td>
                                <td>{{ $jumlah }}</td>
                            </tr>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var tahunOptions = {
        ...
        series: [{
            name: 'Jumlah',
            data: {!! json_encode(array_values($tahunCounts->toArray())) !!}
        }],
        xaxis: {
            categories: {!! json_encode(array_keys($tahunCounts->toArray())) !!},
            labels: { rotate: -45 }
        },
        colors: ['#ff6384'],
        plotOptions: {
    ...
    new ApexCharts(document.querySelector("#tahunChart"), tahunOptions).render();
});
</script>
@endpush
