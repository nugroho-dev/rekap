                  ...
                  <tbody>
                    ...
                    @if($byKbliKategori->count() > 0)
                      <tr class="table-active fw-bold">
                        ...
                        <td class="text-end">{{ number_format($byKbliKategori->sum('total_tenaga_kerja_laki'), 0, ',', '.') }}</td>
                        <td class="text-end">{{ number_format($byKbliKategori->sum('total_tenaga_kerja_perempuan'), 0, ',', '.') }}</td>
