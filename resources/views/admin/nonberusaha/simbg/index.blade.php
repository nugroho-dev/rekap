                    ...
                    <div class="row g-2 align-items-center">
                      ...
                      <div class="col-auto ms-auto d-print-none">
                        <div class="btn-list">
                          ...
                          <a href="{{ url('/pbg/export/excel') . (http_build_query(request()->only(['search','date_start','date_end','month','year'])) ? ('?' . http_build_query(request()->only(['search','date_start','date_end','month','year']))) : '') }}" class="btn btn-outline-secondary d-none d-sm-inline-block ms-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-download"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 3v12"/><path d="M8 11l4 4l4 -4"/><path d="M21 21h-18"/></svg>
                            Export Excel
                          </a>
                          <a href="{{ url('/pbg/export/excel') . (http_build_query(request()->only(['search','date_start','date_end','month','year'])) ? ('?' . http_build_query(request()->only(['search','date_start','date_end','month','year']))) : '') }}" class="btn btn-outline-secondary d-sm-none btn-icon ms-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-download"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 3v12"/><path d="M8 11l4 4l4 -4"/><path d="M21 21h-18"/></svg>
                          </a>
                    ...
                    <div class="d-flex">
                      <div class="text-muted">
                        ...
                        <div class="mx-2 d-inline-block">
                          ...
                          <form action="{{ url('/pbgsort')}}" method="POST">
                            @csrf
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">Impor Data PBG</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                      <div>
                        <label class="form-label">File Data PBG</label>
                          ...
                          <div class="card-body">
                            <div class="tab-content">
                              <div class="tab-pane fade active show" id="tabs-home-8" role="tabpanel">
                                <h4>Pilih Tanggal :</h4>
                                <form method="post" action="{{ url('/pbgsort')}}" enctype="multipart/form-data">
                                  @csrf
