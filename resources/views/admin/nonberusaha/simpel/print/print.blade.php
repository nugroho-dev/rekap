        ...
        <table  style="border-collapse: collapse; width: 100%; border: 1px solid black;">
              <thead>
                <tr style="border: 1px solid black;">
                 ...
                 <th style="border: 1px solid black">Nama Jenazah </th>
              ...
              <tbody> 
                ...
                <tr style="border: 1px solid black; text-align: left;">
                    ...
                    <div style="font-weight: bolder; margin-left: 5px;">{{ $item['pemohon'] }} </div>
                    <div style="margin-left: 5px;">{{ $item->alamat }} RT.{{ $item->rt }} RW.{{ $item->rw }}, Desa/Kel.{{ $item->desa }}, Kec.{{ $item->kec }} Kab/Kota.{{ $item->kota }}</div> 
                    </td>
                    <td style="border: 1px solid black; "><div style="font-weight: bolder; margin-left: 5px;">{{ $item['nama'] }} </div>
                        <div style="margin-left: 5px;">Blok {{ $item['blok'] }}</div>
                    </td>
                    <td style="border: 1px solid black"><div style="font-weight: bolder; margin-left: 5px;">{{ $item['jasa'] }} </div>
                        <div style="margin-left: 5px;">{{ $item['jenis_permohonan'] }}</div> </td>
                    <td style="white-space: nowrap; border: 1px solid black;"><div style="font-weight: bolder; margin-left: 5px;">{{ is_null($item['rekomendasi']) ? '-' : Carbon\Carbon::parse($item['rekomendasi'])->translatedFormat('d F Y') }}</div> </td>
                </tr>
                @endforeach
