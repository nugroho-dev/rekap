                    ...
                    <div class="row g-2 align-items-center">
                      ...
                      <div class="col-auto ms-auto d-print-none">
                        <div class="btn-list">
                          ...
                          <a href="{{ url('/investor/statistik')}}" class="btn btn-info d-none d-sm-inline-block">
                          ...
                          <a href="{{ url('/investor/statistik')}}" class="btn btn-info d-sm-none btn-icon">
                            <!-- Download SVG icon from http://tabler-icons.io/i/plus --> 
                            <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-chart-infographic"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M7 7m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0" /><path d="M7 3v4h4" /><path d="M9 17l0 4" /><path d="M17 14l0 7" /><path d="M13 13l0 8" /><path d="M21 12l0 9" /></svg>
                          </a>
                        </div>
              ...
              <div class="col-lg-12 col-sm-12">
                <div class="card">
                  <div class="card-header border-0">
                    <div class="card-title">Jumlah Proyek OSS Tahun {{ $year }}</div>
                  </div>
                  ...
                  <div class="card-table table-responsive">
                    <table class="table">
                      <thead>
                        <tr>
                          <th>Skala Usaha</th>
                          <th class="text-center">Jumlah Pelaku Usaha</th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="text-center"><strong> Izin</strong></td>
                          <td class="text-center"><strong> Hari</strong></td>
                          <td class="text-center"><strong> Hari</strong></td>
                          <td></td>
                        </tr>
                      </tbody>
