                  ...
                  <td class="text-end">
                    <span class="dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-end">
                        <a class="dropdown-item" href="{{ route('konfigurasi.instansi.edit', $item) }}">Edit</a>

                        <form method="post" action="{{ route('konfigurasi.instansi.destroy', $item) }}" onsubmit="return confirm('Hapus instansi ini?')">
                          @method('delete')
                          @csrf
