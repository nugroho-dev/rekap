...
@section('content')
        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                  <div class="btn-list">
                    <a href="{{ route('konfigurasi.pegawai.index') }}" class="btn btn-primary d-none d-sm-inline-block">
                      Kembali
                    </a>
                  </div>
                </div>
    ...
    <div class="col-md-6 offset-md-3">
      <form class="card" method="post" action="{{ route('konfigurasi.pegawai.store') }}" enctype="multipart/form-data">
         @csrf
        ...
        <div class="card-body">
          <div class="mb-3">
            ...
            <div>
              <input type="text" class="form-control" placeholder="Nama" id="title" value="{{ old('nama') }}" name='nama'>
              @error ('nama')
          ...
          <div class="mb-3">
            ...
            <div>
              <input type="text"  class="form-control" name="pegawai_token" value="{{ $pegawai_token }}" readonly/>
            </div>
          </div>
          ...
          <div class="mb-3">
            ...
            <select class="form-select" id="select-optgroups" name="instansi_uuid" required>
             @foreach ($items as $item)
                <option value="{{ $item->uuid }}" {{ old('instansi_uuid') == $item->uuid ? 'selected' : '' }}>{{ $item->nama_instansi }}</option>
             @endforeach
            </select>
          </div>
          ...
          <div class="mb-3">
            ...
            <img class="img-preview img-fluid mb-3 col-5 rounded mx-auto d-block" style="display:none">
