                ...
                <div class="card">
                  ...
                  <div class="row justify-content-center m-3">
                    <div class="col-lg-9 col-md-12 col-sm-12">
                      <form class="card" method="post" action="{{ url('/business/'.$business->slug.'') }}" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <div class="card-body">
                          <h3 class="card-title">Edit Data Pameran</h3>
                          <div class="row row-cards">
                            <div class="col-md-3 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="date" class="form-control" name="tanggal"  placeholder="" value="{{ old('tanggal', $business->tanggal) }}">
                                @error ('tanggal')
                            ...
                            <div class="col-md-9 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nama_bisnis" placeholder="Business Meeting"  id="title" value="{{ old('nama_bisnis', $business->nama_bisnis) }}">
                                @error ('nama_bisnis')
                                <small class="form-hint text-danger">{{ $message }}  </small>
                                @enderror
                              </div>
                            ...
                            <div class="col-md-9 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Slug" id="slug" name="slug"  value="{{ old('slug', $business->slug) }}" readonly>
                                @error ('slug')
                                <small class="form-hint text-danger">{{ $message }}  </small>
                                @enderror
                              </div>
                            ...
                            <div class="col-md-12 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="tempat" placeholder="Tempat"  value="{{ old('tempat', $business->tempat) }}">
                                @error ('tempat')
                                <small class="form-hint text-danger">{{ $message }}  </small>
                                @enderror
                              </div>
                              ...
                              <div class="mb-3">
                                ...
                                <div class="input-group">
                                  <span class="input-group-text">
                                    <input type="hidden" name="oldFile" value="{{ $business->file }}">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="flexible-container">
                        <embed src="{{ url(Storage::url($business->file)) }}" class="docpdf-preview" id="my-object" width="100%" type="application/pdf" height="650"></embed>
                      </div>
                    </div>
                    <div class="modal-footer">
