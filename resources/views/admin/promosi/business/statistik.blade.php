    ...
    <div class="page-header d-print-none mb-3">
        <div class="row align-items-center">
            <div class="col">
                ...
                <div class="text-muted mt-1">Statistik Business Meeting berdasarkan status dan tren bulanan.</div>
            </div>
        ...
        <div class="col-md-3">
            <div class="card shadow-sm border-0">
                <div class="card-body text-center">
                    ...
                    <div class="text-muted">Total Business Meeting</div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card shadow-lg border-0">
                <div class="card-header bg-primary-lt">
                    <h3 class="card-title mb-0">Tren Business Meeting Tahun {{ $year }}</h3>
                </div>
