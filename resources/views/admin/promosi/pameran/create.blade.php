                ...
                <div class="card">
                  ...
                  <div class="row justify-content-center m-3">
                    <div class="col-lg-9 col-md-12 col-sm-12">
                      <form class="card" method="post" action="{{ url('/expo') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                          ...
                          <div class="row row-cards">
                            <div class="col-md-3 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="date" class="form-control" name="tanggal_mulai"  placeholder="" value="{{ old('tanggal_mulai') }}">
                                @error ('tanggal_mulai')
                            ...
                            <div class="col-md-3 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="date" class="form-control" name="tanggal_akhir"  placeholder="" value="{{ old('tanggal_akhir') }}">
                                @error ('tanggal_akhir')
                                <small class="form-hint text-danger">{{ $message }}  </small>
                                @enderror
                              </div>
                            ...
                            <div class="col-md-9 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nama_expo" placeholder="Nama Event (Pameran)"  id="title" value="{{ old('nama_expo') }}">
                                @error ('nama_expo')
                                <small class="form-hint text-danger">{{ $message }}  </small>
                                @enderror
                              </div>
