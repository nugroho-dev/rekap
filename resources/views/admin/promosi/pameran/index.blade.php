...
@section('content')
                    ...
                    <div class="row g-2 align-items-center">
                      ...
                      <div class="col-auto ms-auto d-print-none">
                        <div class="btn-list">
                          ...
                          <a href="{{ url('/expo/statistik')}}" class="btn btn-info d-none d-sm-inline-block">
                          ...
                          <a href="{{ url('/expo/statistik')}}" class="btn btn-info d-sm-none btn-icon">
                            <!-- Download SVG icon from http://tabler-icons.io/i/plus --> 
                            <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-chart-infographic"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M7 7m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0" /><path d="M7 3v4h4" /><path d="M9 17l0 4" /><path d="M17 14l0 7" /><path d="M13 13l0 8" /><path d="M21 12l0 9" /></svg>
                          </a>
                        </div>
                      ...
                      <div class="col-auto ms-auto d-print-none">
                        <div class="btn-list">
                          ...
                          <a href="{{ url('/expo/create') }}" class="btn btn-primary d-none d-sm-inline-block" >
                            <!-- Download SVG icon from http://tabler-icons.io/i/plus --> 
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Data Pameran @if($date_start&&$date_end) : {{ Carbon\Carbon::parse($date_start)->translatedFormat('d F Y') }} Sampai Dengan {{ Carbon\Carbon::parse($date_end)->translatedFormat('d F Y') }}@endif @if($month) Bulan {{ Carbon\Carbon::createFromDate(null,$month,1)->translatedFormat('F') }}  @endif @if($year) Tahun {{ $year }}  @endif </h3>
                  </div>
                  ...
                  <div class="table-responsive">
                    <table class="table card-table table-vcenter text-nowrap  table-striped ">
                      <thead class="text-center">
                        <tr>
                          <th class="w-1" >No.</th>
                          <th class="w-1" >Nama Event (Pameran)</th>
                          <th >Tempat</th>
                      ...
                      <tbody class="font-monospace fs-5" >
                       @php
                        ...
                        <tr>
                          ...
                          <td>{{ $item->nama_expo }}</td>
                          <td class="text-center">{{ $item->tempat }}</td>
                          <td class="text-center">{{ Carbon\Carbon::parse($item->tanggal_mulai)->translatedFormat('d F Y') }} - {{ Carbon\Carbon::parse($item->tanggal_akhir)->translatedFormat('d F Y') }}</td>
                          <td class="text-center">
                            <span class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item" href="{{ url('/expo/'.$item->slug.'/edit')}}" >
                                  Edit
                                </a>
              ...
              <div class="modal  fade" id="modal-team" tabindex="-1" role="dialog" aria-hidden="true">
                <form method="post" action="{{ url('/expo/import_excel')}}" enctype="multipart/form-data">
                  {{ csrf_field() }}
                          ...
                          <div class="card-body">
                            <div class="tab-content">
                              <div class="tab-pane fade active show" id="tabs-home-8" role="tabpanel">
                                <h4>Pilih Tanggal :</h4>
                                <form method="get" action="{{ url('/expo')}}" enctype="multipart/form-data">
                ...
                <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body text-center py-4">
                      ...
                      <h3>Anda yakin ?</h3>
                      <div class="text-secondary">Hapus Data Pameran <span id="userName"></span> !</div>
                    </div>
                    <div class="modal-footer">
                      <div class="w-100">
                        <div class="row">
                ...
                <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body text-center py-4">
                      ...
                      <!--<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon mb-2 text-danger icon-lg"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M12 9v4"></path><path d="M10.363 3.591l-8.106 13.534a1.914 1.914 0 0 0 1.636 2.871h16.214a1.914 1.914 0 0 0 1.636 -2.87l-8.106 -13.536a1.914 1.914 0 0 0 -3.274 0z"></path><path d="M12 16h.01"></path></svg>-->
                      <h3>Peringatan</h3>
                      <div class="text-secondary">Dokumen Laporan Pameran <span id="userName"></span> tidak tersedia !</div>
                    </div>
                    <div class="modal-footer">
                      <div class="w-100">
                        <div class="row">
...
<script>
    $(document).ready(function() {
        $('.openModal').on('click', function() {
            ...
            $.ajax({
                url: `{{ url('/expo/')}}/${userId}`, // Endpoint resource controller
                type: 'GET',
                success: function(data) {
                  ...
                  if (data.file) {
                      ...
                      $('#editLoi').attr('href', `expo/${dataSlug}/edit`);
        ...
        $('.openModalDel').on('click', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                  const dataSlug = data.slug;
                  if (data.slug) {
                        $('#delLoi').attr('action', `expo/${dataSlug}`);
                        $('#userName').text(data.nama_expo);
