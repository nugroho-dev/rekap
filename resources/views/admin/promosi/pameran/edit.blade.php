                ...
                <div class="card">
                  ...
                  <div class="row justify-content-center m-3">
                    <div class="col-lg-9 col-md-12 col-sm-12">
                      <form class="card" method="post" action="{{ url('/expo/'.$expo->slug.'') }}" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <div class="card-body">
                          <h3 class="card-title">Edit Data Pameran</h3>
                          <div class="row row-cards">
                            <div class="col-md-3 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="date" class="form-control" name="tanggal_mulai"  placeholder="" value="{{ old('tanggal_mulai', $expo->tanggal_mulai) }}">
                                @error ('tanggal_mulai')
                            ...
                            <div class="col-md-3 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="date" class="form-control" name="tanggal_akhir"  placeholder="" value="{{ old('tanggal_akhir', $expo->tanggal_akhir) }}">
                                @error ('tanggal_akhir')
                                <small class="form-hint text-danger">{{ $message }}  </small>
                                @enderror
                              </div>
                            ...
                            <div class="col-md-9 col-sm-12">
                              <div class="mb-3">
                                <label class="form-label">Nama Event (Pameran)</label>
                                <input type="text" class="form-control" name="nama_expo" placeholder="Nama Event (Pameran)"  id="title" value="{{ old('nama_expo', $expo->nama_expo) }}">
                                @error ('nama_expo')
                                <small class="form-hint text-danger">{{ $message }}  </small>
                                @enderror
                              </div>
                            ...
                            <div class="col-md-9 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Slug" id="slug" name="slug"  value="{{ old('slug', $expo->slug) }}" readonly>
                                @error ('slug')
                                <small class="form-hint text-danger">{{ $message }}  </small>
                                @enderror
                              </div>
                            ...
                            <div class="col-md-12 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="tempat" placeholder="Tempat"  value="{{ old('tempat', $expo->tempat) }}">
                                @error ('tempat')
                                <small class="form-hint text-danger">{{ $message }}  </small>
                                @enderror
                              </div>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="flexible-container">
                        <embed src="{{ url(Storage::url($expo->file)) }}" class="docpdf-preview" id="my-object" width="100%" type="application/pdf" height="650"></embed>
                      </div>
                    </div>
                    <div class="modal-footer">
