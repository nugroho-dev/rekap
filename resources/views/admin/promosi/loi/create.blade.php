...
@section('content')
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Tambah Data LOI </h3>
                  </div>
                  <div class="row justify-content-center m-3">
                    <div class="col-lg-9 col-md-12 col-sm-12">
                      <form class="card" method="post" action="{{ url('/loi') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                          <h3 class="card-title">Tambah Data LOI</h3>
                          <div class="row row-cards">
                            ...
                            <div class="col-md-9 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nama_perusahaan" placeholder="Nama Perusahaan"  id="title" value="{{ old('nama_perusahaan') }}">
                            ...
                            <div class="col-md-12 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="alamat" placeholder="Alamat Perusahaan"  value="{{ old('alamat') }}">
                                @error ('alamat')
                                <small class="form-hint text-danger">{{ $message }}  </small>
                                @enderror
                              </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="bidang_usaha" placeholder="Bidang Usaha"  value="{{ old('bidang_usaha') }}">
                                @error ('bidang_usaha')
                                <small class="form-hint text-danger">{{ $message }}  </small>
                                @enderror
                              </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="telp" placeholder="Nomor Telp"  value="{{ old('telp') }}">
                                @error ('telp')
                                <small class="form-hint text-danger">{{ $message }}  </small>
                                @enderror
                              </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="peminatan_bidang_usaha" placeholder="Kepeminatan Bidang Usaha"  value="{{ old('peminatan_bidang_usaha') }}">
                            ...
                            <div class="col-md-8 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="lokasi" placeholder="Preferensi Lokasi"  value="{{ old('lokasi') }}">
                                @error ('lokasi')
                                <small class="form-hint text-danger">{{ $message }}  </small>
                                @enderror
                              </div>
                            ...
                            <div class="col-md-4 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="status_investasi" placeholder="Status Investasi"  value="{{ old('status_investasi') }}">
                            ...
                            <div class="col-md-6 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="nilai_investasi_dolar" placeholder="Nilai Investasi Dalam US$"  value="{{ old('nilai_investasi_dolar') }}">
                            ...
                            <div class="col-md-6 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="nilai_investasi_rupiah" placeholder="Nilai Investasi Dalam Rp"  value="{{ old('nilai_investasi_rupiah') }}">
                            ...
                            <div class="col-md-6 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="tki" placeholder="Rencana Tenaga Kerja Indonesia"  value="{{ old('tki') }}">
                                @error ('tki')
                                <small class="form-hint text-danger">{{ $message }}  </small>
                                @enderror
                              </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="tka" placeholder="Rencana Tenaga Kerja Asing"  value="{{ old('tka') }}">
                                @error ('tka')
                                <small class="form-hint text-danger">{{ $message }}  </small>
                                @enderror
                              </div>
                            ...
                            <div class="col-md-12">
                              <div class="mb-3 mb-0">
                                ...
                                <textarea rows="5" class="form-control" placeholder="Here can be your description" name="deskripsi">{{ old('deskripsi') }}</textarea>
                                @error ('deskripsi')
                                <small class="form-hint text-danger">{{ $message }}  </small>
                                @enderror
                              </div>
              ...
              <script>
                ...
                title.addEventListener('change', function(){
                    fetch('{{ url('/loi/check/checkSlug') }}?title='+ title.value)
