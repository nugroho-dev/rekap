                    ...
                    <div class="row g-2 align-items-center">
                      ...
                      <div class="col-auto ms-auto d-print-none">
                        <div class="btn-list">
                          ...
                          <a href="{{ url('/bimtek/statistik')}}" class="btn btn-info d-none d-sm-inline-block">
                          ...
                          <a href="{{ url('/bimtek/statistik')}}" class="btn btn-info d-sm-none btn-icon">
                            <!-- Download SVG icon from http://tabler-icons.io/i/plus --> 
                            <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-chart-infographic"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M7 7m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0" /><path d="M7 3v4h4" /><path d="M9 17l0 4" /><path d="M17 14l0 7" /><path d="M13 13l0 8" /><path d="M21 12l0 9" /></svg>
                          </a>
                        </div>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Data Bimtek {{ $bimtek->acara }}  Tanggal {{ Carbon\Carbon::parse($bimtek->tanggal_pelaksanaan)->translatedFormat('d F Y') }} </h3>
                  </div>
                  <div class="row justify-content-center m-3">
                    <div class="col-lg-9 col-md-12 col-sm-12">
                      <form class="card" method="post" action="{{ url('/bimtek/'.$bimtek->id.'') }}" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <div class="card-body">
                          <h3 class="card-title">Edit   Bimtek</h3>
                          <div class="row row-cards">
                            <div class="col-md-4 col-sm-12">
                              <div class="mb-3">
                                <label class="form-label">Tanggal Pelaksanaan</label>
                                <input type="date" class="form-control" name="tanggal_pelaksanaan"  placeholder="" value="{{ $bimtek->tanggal_pelaksanaan }}">
                            ...
                            <div class="col-md-3 col-sm-12">
                              <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="jumlah_peserta" placeholder="" value="{{ old('jumlah_peserta',$bimtek->jumlah_peserta) }}">
                            ...
                            <div class="col-md-5 col-sm-12">
                              <div class="mb-3">
                                <label class="form-label">Satuan Peserta</label>
                                <input type="text" class="form-control" name="satuan_peserta" placeholder="" value="{{ old('satuan_peserta',$bimtek->satuan_peserta) }}">
                                @error ('satuan_peserta')
                                <small class="form-hint text-danger">{{ $message }}  </small>
                                @enderror
                              </div>
                            </div>
                              ...
                              <div class="mb-3">
                                ...
                                <div class="input-group">
                                  <span class="input-group-text">
                                    <input type="hidden" name="oldFile" value="{{ $bimtek->file }}">
                            ...
                            <div class="col-md-12">
                              <div class="mb-3 mb-0">
                                ...
                                <textarea rows="5" class="form-control" placeholder="Here can be your description" name="acara">{{ old('acara',$bimtek->acara) }}</textarea>
                                @error ('acara')
                                <small class="form-hint text-danger">{{ $message }}  </small>
                                @enderror
                              </div>
                            ...
                            <div class="col-md-12">
                              <div class="mb-3 mb-0">
                                ...
                                <textarea rows="5" class="form-control" placeholder="Here can be your description" name="tempat">{{ old('tempat',$bimtek->tempat) }}</textarea>
                                @error ('tempat')
                                <small class="form-hint text-danger">{{ $message }}  </small>
                                @enderror
                              </div>
                            ...
                            <div class="col-md-12">
                              <div class="mb-3 mb-0">
                                ...
                                <textarea rows="5" class="form-control" placeholder="Here can be your description" name="keterangan">{{ old('keterangan',$bimtek->keterangan) }}</textarea>
                                @error ('keterangan')
                                <small class="form-hint text-danger">{{ $message }}  </small>
                                @enderror
                              </div>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="flexible-container">
                        <embed src="{{ url(Storage::url($bimtek->file)) }}" class="docpdf-preview" id="my-object" width="100%" type="application/pdf" height="650"></embed>
                      </div>
                    </div>
                    <div class="modal-footer">
