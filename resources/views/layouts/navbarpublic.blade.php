       ...
       data-bs-placement="bottom">
          ...
          <div class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
              ...
              <a href="{{ url('/setting') }}" class="dropdown-item">Profile</a>
                          ...
                          <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                              @foreach($kat->jenisInformasi as $jenis)
                                @if($jenis->link_api)
                                  <a class="dropdown-item" href="{{ url($jenis->link_api) }}" target="_self">
                                    @if($jenis->icon)
                                ...
                                @elseif($jenis->dataset)
                                  <a class="dropdown-item" href="{{ url($jenis->dataset) }}" target="_self">
                                    @if($jenis->icon)
                                      <span class="me-2">{!! $jenis->icon !!}</span>
                                    @endif
                                    {{ $jenis->label }}
