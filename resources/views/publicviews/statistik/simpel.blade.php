  ...
  <div class="card stats-card">
    <div class="card-body">
      <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
          <h3 class="mb-0">Statistik Izin Pemakaman</h3>
          <div class="small-muted">Ringkasan data izin pemakaman</div>
        </div>
        <div class="text-end">
      ...
      <div class="row g-3 mb-3">
        ...
        <div class="col-md-4 col-sm-12">
          ...
          <div class="mini-card">
            <div class="muted mb-2">Top Jasa (Izin Terbit)</div>
            ...
            <div class="mt-2 text-center">
              ...
              <button type="button" class="btn btn-sm btn-outline-primary ms-2" data-bs-toggle="modal" data-bs-target="#profesiPerBulanModal">Jasa per Bulan</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row g-3 mb-3">
        <div class="col-md-12 col-sm-12">
          <div class="mini-card">
            <div class="d-flex justify-content-between align-items-center mb-2">
              <div class="muted">Komposisi Jasa per Tahun</div>
            </div>
      ...
      <div class="row g-3 mb-3">
        <div class="col-md-6 col-sm-12">
          <div class="mini-card">
            <div class="muted">Top Jasa (Donut)</div>
            <div id="chart-top-profesi" style="height:260px"></div>
          </div>
        </div>
        <div class="col-md-6 col-sm-12">
          <div class="mini-card">
            <div class="muted">Kumulatif per Jasa (Area)</div>
...
<div class="modal fade" id="dailyProfesiModal" tabindex="-1" aria-labelledby="dailyProfesiModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="dailyProfesiModalLabel">Rincian Jasa</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
...
<div class="modal fade" id="profesiModal" tabindex="-1" aria-labelledby="profesiModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="profesiModalLabel">Daftar Jasa (Izin Terbit)</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="table-responsive">
...
<div class="modal fade" id="profesiPerBulanModal" tabindex="-1" aria-labelledby="profesiPerBulanLabel" aria-hidden="true">
  <div class="modal-dialog modal-fullscreen modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="profesiPerBulanLabel">Jumlah Jasa per Bulan</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="table-responsive">
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  (function(){
    ...
    // Komposisi Jasa per Tahun: horizontal bar per jasa (total dalam 1 tahun)
    try{
    ...
    // Top jasa donut (legend hidden) with data labels
    try{
    ...
    // Cumulative area for top 6 jasa with modern styling
    try{
