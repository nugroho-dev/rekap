...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('lkpm_non_umk', function (Blueprint $table) {
            ...
            $table->decimal('nilai_modal_tetap_rencana', 20, 2)->nullable();
            $table->decimal('nilai_total_investasi_rencana', 20, 2)->nullable();
            $table->decimal('tambahan_modal_tetap_realisasi', 20, 2)->nullable();
            $table->text('penjelasan_modal_tetap')->nullable();
            $table->decimal('total_tambahan_investasi', 20, 2)->nullable();
            $table->decimal('akumulasi_realisasi_modal_tetap', 20, 2)->nullable();
            $table->decimal('akumulasi_realisasi_investasi', 20, 2)->nullable();
