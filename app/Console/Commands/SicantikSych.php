...
class SicantikSych extends Command
{
    ...
    public function handle()
    {
        ...
        foreach ($items as $val) {
            ...
            ['token'=> $val['token']],
            ['pemohon'=> $val['pemohon'],
                    'daftar' => is_null($val['daftar']) ? is_null($val['daftar']) : Carbon::parse($val['daftar'])->translatedFormat('Y-m-d'),
                    'konfirm' => is_null($val['konfirm']) ? is_null($val['konfirm']) : Carbon::parse($val['konfirm'])->translatedFormat('Y-m-d'),
                    'validasi' => is_null($val['validasi']) ? is_null($val['validasi']) : Carbon::parse($val['validasi'])->translatedFormat('Y-m-d'),
                    'rekomendasi' => is_null($val['rekomendasi']) ? is_null($val['rekomendasi']) : Carbon::parse($val['rekomendasi'])->translatedFormat('Y-m-d'),
                    'review' => is_null($val['review']) ? is_null($val['review']) : Carbon::parse($val['review'])->translatedFormat('Y-m-d'),
                    'otorisasi' => is_null($val['otorisasi']) ? is_null($val['otorisasi']) : Carbon::parse($val['otorisasi'])->translatedFormat('Y-m-d'),
                    'tte' =>  is_null($val['tte']) ? is_null($val['tte']) : Carbon::parse($val['tte'])->translatedFormat('Y-m-d'),
            'nama'=>$val['nama'],
            'gender'=>$val['gender'],
            'agama'=>$val['agama'],
                    'lahir' => is_null($val['lahir']) ? is_null($val['lahir']) : Carbon::parse($val['lahir'])->translatedFormat('Y-m-d'),
                    'wafat' => is_null($val['wafat']) ? is_null($val['wafat']) : Carbon::parse($val['wafat'])->translatedFormat('Y-m-d'),
                    'kubur' => is_null($val['kubur']) ? is_null($val['kubur']) : Carbon::parse($val['kubur'])->translatedFormat('Y-m-d'),
            'blok' => $val['blok'],
            'waris'=>$val['waris'],
            'telp'=>$val['telp'],
            'alamat'=>$val['alamat'],
