    ...
    */
    public function model(array $row)
    {
        return new Berusaha([
            ...
            'nib' => $row['nib'],
            'day_of_tanggal_terbit_oss' => Carbon::createFromFormat('d/m/y', $row['day_of_tanggal_terbit_oss'])->format('Y-m-d'),//createFromFormat('d/m/Y',$row[4])->format('Y-m-d'),//$row[4]->setDateFormat('Y-m-d'),// //format('Y-m-d'),
            ...
            'kbli' => $row['kbli'],
            'day_of_tgl_izin' => Carbon::createFromFormat('d/m/y',$row['day_of_tgl_izin'])->format('Y-m-d'),
